...
import (
	...
	cert_manager_v1 "k8s.io/api/cert-manager/v1"
...
#kue: kue.#KUE & {
	...
	#resources: {
		...
		challenges?: [_]:                        acme_v1.#Challenge
		orders?: [_]:                            acme_v1.#Order
		...
		jobs?: [_]:                              batch_v1.#Job
		certificaterequests?: [_]:               cert_manager_v1.#CertificateRequest
		certificates?: [_]:                      cert_manager_v1.#Certificate
		clusterissuers?: [_]:                    cert_manager_v1.#ClusterIssuer
		issuers?: [_]:                           cert_manager_v1.#Issuer
